...
La aplicación sigue un patrón de diseño modular basado en capas para asegurar la escalabilidad:
    ...
    Presentación: Interfaces desarrolladas en PyQt5 (archivos .ui) y lógica de vista en Python.
    Capa de Datos (DAL): Objeto de Acceso a Datos que centraliza las consultas SQL hacia SQLite.
    Lógica de negocio: Cálculo de IVA, comisión SumUp, cuadratura de caja, generación de reportes. Independiente de UI y BD
...
Funcionalidades Implementadas
    ...
    Dashboard: Resumen automatizado de ventas totales y transacciones por pyme.
    Registro de Ventas: Formulario con soporte para múltiples métodos de pago (Efectivo y SumUp).
    Localización: Sistema de fechas y moneda adaptado al contexto de Chile.
    Reportes: Vista consolidada de movimientos mensuales para auditoría interna.
